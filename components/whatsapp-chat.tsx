  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-50 hidden md:flex items-center gap-2 bg-[#25D366] hover:bg-[#20BD5A] text-white font-medium pl-4 pr-5 py-3 rounded-full shadow-lg shadow-[#25D366]/30 hover:shadow-xl hover:shadow-[#25D366]/40 transition-all duration-300"
...
export function WhatsAppChatButton({ className = "" }: { className?: string }) {
  ...
  return (
    <>
      <button
        onClick={() => setIsOpen(true)}
        className={`inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#20BD5A] text-white font-medium px-3 py-2 rounded-lg shadow-md shadow-[#25D366]/25 transition-all duration-300 ${className}`}
      >
      ...
      >
        ...
        <div className="bg-[#F0F0F0] px-3 py-2 flex items-end gap-2 shrink-0">
          ...
          <button
            ...
            className="w-10 h-10 rounded-full bg-[#25D366] hover:bg-[#20BD5A] disabled:bg-gray-300 disabled:cursor-not-allowed text-white flex items-center justify-center transition-colors shrink-0"
